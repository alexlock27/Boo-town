...
| **No real-world song melodies** | **RELAX** | The app *already breaks this rule* and is right to: the Boo Band ships Twinkle Twinkle, Row Your Boat and Old MacDonald note-for-note (`data/songs.js:24-45`), all public domain and documented as such. The rule's purpose (never infringe) is met; its letter would delete three tunes small children know. **Drafted rewrite:** *"No melody ships unless its licence is verifiable in the repo. Original composition is the default; traditional/public-domain melodies are allowed where they serve the child, with the public-domain basis recorded beside the notes. Nothing under copyright, ever."* |
