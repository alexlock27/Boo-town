...
const OLD = { version: 3, name: 'Ada', guide: { species: 'giraffe', body: 'sunshine', pattern: 'spots', patternColour: 'cocoa', eyes: 'round', acc: 'none', name: 'T' }, inventory: { boo_inky: 3, boo_disco: 1 }, boxes: 0, meter: 3, opened: 4, pity: { commons: 0 }, nicknames: { boo_inky: 'Inkster' }, equips: {}, catBest: {}, spellingMastery: { because: 4 }, ledger: { 'tmul7:8': { rights: 5, misses: 1, lastSeen: 1 } }, stars: { total: 200, byGame: {} }, town: [], settings: { sound: false, music: false, voice: false }, seen: { trophyRetro: true, introSeen: { bubblepop: 1, feedboos: 1, spellboo: 1, blocks: 1, bounce: 1, beat: 1, dash: 1, clockshop: 1, boopop: 1, teachme: 1 } }, trophies: { medal_stars_100: '2026-07-01', trophy_zones: '2026-07-01' } };
