...
const SAVE = { version: 3, name: 'Ada', guide: { species: 'giraffe', body: 'lilac', pattern: 'spots', patternColour: 'indigo', eyes: 'round', acc: 'bow', name: 'Twiggy' }, inventory: { boo_inky: 1, boo_disco: 1 }, boxes: 0, meter: 2, opened: 2, pity: { commons: 0 }, nicknames: {}, equips: {}, catBest: {}, town: [], stars: { total: 120, byGame: {} }, spellingMastery: {}, ledger: {}, trickyPile: [], golden: null, goldenLastDouble: '', quests: { day: '', list: [], done: [], progress: {}, boxDay: '' }, journal, settings: { sound: false, music: false, voice: false }, seen: { trophyRetro: true }, trophies: { medal_stars_100: '2026-07-01' } };
