...
const SAVE = (growth) => {
  ...
  return { version: 5, name: 'Ada', guide: { species: 'giraffe', body: 'sunshine', pattern: 'spots', patternColour: 'cocoa', eyes: 'round', acc: 'none', name: 'T' }, inventory: inv, boxes: 0, meter: 0, opened: 10, pity: { commons: 0 }, nicknames: {}, equips: {}, catBest: {}, town: [{ zone: 'meadow', x: 0.5, item: 'boo_inky' }, { zone: 'meadow', x: 0.6, item: 'boo_plum' }], stars: { total: 60, byGame: {} }, ledger: {}, townGrowth: growth, settings: { sound: false, music: false, voice: false, content: 'full' }, seen: { trophyRetro: true, townFirst: true, zonesUnlocked: ['meadow', 'riverside'] }, trophies: { medal_boos_10: '2026-07-01' }, ageAsked: true, age: 8 };
};
