...
// boo_birthday_twin1 ARE caught (underscore is a regex word char) while legitimate words
// (Styler, flexible) and name-free ids (boo_birthday_one) pass.
const L = '(?<![a-z])', R = '(?![a-z])';
const PATTERNS = [
  { re: new RegExp(L + 'twin1' + R, 'i'), what: 'a retired first name' },
  { re: new RegExp(L + 'twin2' + R, 'i'), what: 'a retired first name' },
