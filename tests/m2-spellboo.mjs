...
await page.evaluate(() => localStorage.setItem('bootown.save.v1', JSON.stringify({ version: 1, name: 'Maya', guide: { body: 'lilac', patch: 'pink', acc: 'headphones', name: 'Twiggy' }, settings: { sound: true, music: true, voice: true } })));
